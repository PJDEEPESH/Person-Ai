...
**PJDEEPESH** - [GitHub Profile](https://github.com/PJDEEPESH)

## 📞 Support

For issues, questions, or suggestions:
- Open an issue on [GitHub Issues](https://github.com/PJDEEPESH/Person-Ai/issues)
- Visit the [Contact Page](https://github.com/PJDEEPESH/Person-Ai) in the application

## 🙏 Acknowledgments

- [Groq](https://groq.com) for fast AI inference
- [Deepgram](https://deepgram.com) for advanced voice AI
